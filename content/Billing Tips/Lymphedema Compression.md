...
CMS has established five not otherwise specified HCPCS codes to identify compression bandaging supplies, accessories, wraps, and compression garments that are not identified by a unique HCPCS code:
...
The right (RT) and left (LT) modifiers must be used with gradient compression garments, related supplies and accessories when laterality is indicated (HCPCS codes A6515, A6516, A6517, A6518, A6520, A6521, A6522, A6523, A6524, A6525, A6526, A6527, A6530, A6533, A6534, A6535, A6552, A6553, A6554, A6555, A6556, A6557, A6558, A6565, A6572, A6573, A6574, A6575, A6576, A6577, A6578, A6579, A6580, A6581, A6582, A6583, A6584, A6585, A6586, A6587, A6588, A6594, A6595, A6610, and A6611). When the same code for bilateral items (left and right) is billed on the same date of service, bill each item on two separate claim lines using the RT and LT modifiers and 1 unit of service (UOS) on each claim line. Do not use the RTLT modifier on the same claim line and bill with 2 UOS. Claims billed without modifiers RT and/or LT, or with RTLT on the same claim line and 2 UOS, will be rejected as incorrect coding.
